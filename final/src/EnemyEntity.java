...
public class EnemyEntity extends Entity {
  ...
  /* construct a new enemy - the game in which the enemy is being created the 
    image representing the enemy x, y - initial location of enemy */
  ...
  public void move (long delta){
    ...
    if(y > 550) {
    	...
    	//decides where enemy will be regenerated
    	 y  -= (int)(Math.random() * ((1000 - 700) + 1)) + 700;
    	
    	 // sets the bounds for the enemy moving up and down
         yUpBounds = (int)y-50;
         yDownBounds = (int)y+50;
    }//if
  ...
  /* doLogic Updates the game logic related to the enemys,  
    move it down the screen and change direction */
  public void doLogic() {
  ...
  /* collidedWith - the entity with which the enemy has collided */
